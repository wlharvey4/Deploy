...
{{{subheading(Demonstration Video)}}}

#+begin_cartouche
The demonstration video 
#+texinfo:@ifnothtml
[[file:videos/task_1-deploy_infrastructure.mp4][Deploy Infrastructure]]
#+texinfo:@end ifnothtml
#+texinfo:@ifhtml
[[https://content.aws.training/wbt/dydesl-1/en/m1/1.0.0/assets/TVUL_6CHVMwTpnji_transcoded-3hPzrTMrT9GaRJVw-lab-1-creating-infrastructure-v-3-np.mp4][Deploy Infrastructure]]
#+texinfo:@end ifhtml
...
The demonstration video 
#+texinfo:@ifnothtml
[[file:videos/task_2-deploy_LAMP_app.mp4][Deploy a Monolithic LAMP App]]
#+texinfo:@end ifnothtml
#+texinfo:@ifhtml
[[https://content.aws.training/wbt/dydesl-1/en/m1/1.0.0/assets/Gs3DclDRQoqTuCVs_transcoded-tFql-N5n17l90CqN-lab-2-deploy-monolithic-application-v-3.mp4][Deploy a Monolithic LAMP App]]
#+texinfo:@end ifhtml
will take you step by step through the lab process.
#+end_cartouche
...
The demonstration video 
#+texinfo:@ifnothtml
[[file:videos/task_3-connect_to_Lightsail_db.mp4][Connect to a Lightsail DB]]
#+texinfo:@end ifnothtml
#+texinfo:@ifhtml
[[https://content.aws.training/wbt/dydesl-1/en/m1/1.0.0/assets/VtutClkqwt6dYQv8_transcoded-tThAnzz93m6t1YLV-lab-3-configure-lightsail-database.mp4][Connect to a Lightsail DB]]
#+texinfo:@end ifhtml
will take you step by step through the lab process.
#+end_cartouche
...
The demonstration video 
#+texinfo:@ifnothtml
[[file:videos/task_4-scale_PHP_front_end.mp4][Scaling the PHP Front End]]
#+texinfo:@end ifnothtml
#+texinfo:@ifhtml
[[https://content.aws.training/wbt/dydesl-1/en/m1/1.0.0/assets/Vjuth8SgMnLbYZRP_transcoded-PLk0AhKBTaQVSmSZ-lab-4-scaling-the-front-end.mp4][Scaling the PHP Front End]]
#+texinfo:@end ifhtml
will take you step by step through the lab process.
#+end_cartouche
...
The demonstration video 
#+texinfo:@ifnothtml
[[file:videos/migrate.mp4][Migrate to a Relational DB]]
#+texinfo:@end ifnothtml
#+texinfo:@ifhtml
[[https://content.aws.training/wbt/dydesl-1/en/m1/1.0.0/assets/O3hzXVCP6amUD7Ut_transcoded-ZFDO0aztC-Dim-gP-lab-5-migrate-to-rds-v-3-np.mp4][Migrate to a Relational DB]]
#+texinfo:@end ifhtml
will take you step by step through the lab process.
#+end_cartouche
...
The demonstration video 
#+texinfo:@ifnothtml
[[file:videos/task_6-upgrade_to_EC2.mp4][Upgrade to an EC2 Instance]]
#+texinfo:@end ifnothtml
#+texinfo:@ifhtml
[[https://content.aws.training/wbt/dydesl-1/en/m1/1.0.0/assets/SoaHZeUzC-cfHmgg_transcoded-UJi2bwWFqF9GLOEF-lab-6-export-to-ec-2-v-2.mp4][Upgrade to an EC2 Instance]]
#+texinfo:@end ifhtml
will take you step by step through the lab process.
#+end_cartouche
