...
***** Domain Name
The name, such as =example.com=, that a user types in the address bar of a web
browser to access a website or a web application.
...
***** Domain Reseller
A company that sells domain names for registrars such as Amazon
Registrar. Amazon Route 53 is a domain reseller for Amazon Registrar and for
...
=192.0.2.44=).[fn::This is not quite accurate.  DNS is a /naming system/, not a
service.  DNS name servers provide this service by using the DNS to translate
...
1. You register the domain name that you want your users to use to access your
   content.
